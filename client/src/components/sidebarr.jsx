...
export default function Sidebarr() {
  ...
  return (
    <>
      ...
      <div
        className={`flex  right-0 fixed h-full z-20 duration-200 ease-in-out  ${
          showSidebar ? "-translate-x-full" :" translate-x-0  overflow-hidden"
        }`}
      >
        <button
        ...
        <div className="flex flex-col h-screen p-6 bg-slate-200 shadow w-60 dark:bg-slate-800">
          <div className="space-y-3">
            ...
            <img
                ...
                />
              <h2 className="text-xl font-bold dark:text-white">Hi, {state.user}!</h2>
