...
const SearchBar = () => {
    ...
    const handleSearch = (e) => {
      ...
      // Perform the search based on the search query and task tags
      const searchResults = state.tasks.filter((task) => {
        const taskTags = task.tags.map((tag) => tag.toLowerCase());
        return taskTags.includes(searchQuery.toLowerCase());
      });
        ...
        <div className="flex">
          ...
          <div className="relative w-full">
            <input
              ...
              placeholder="Search Tags, Projects, Tasks  Users..."
              required
              value={searchQuery}
